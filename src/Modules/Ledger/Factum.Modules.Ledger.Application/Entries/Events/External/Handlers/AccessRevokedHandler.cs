...
namespace Factum.Modules.Ledger.Application.Entries.Events.External.Handlers
{
    internal class AccessRevokedHandler : IEventHandler<AccessRevoked>
    {
        ...
        public AccessRevokedHandler(ILogger<AccessGrantedHandler> logger, IEntryRepository entryRepository, IDomainEventDispatcher domainEventDispatcher)
        {
